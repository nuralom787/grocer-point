...
import payMethod from '../../public/Payment-Brands.jpg';
                ...
                <div className='hidden lg:block py-10 max-w-screen-2xl mx-auto px-4 lg:px-6'>
                    <ul className='flex justify-center items-center gap-8 font-poppins text-[#151515] text-sm font-semibold'>
                        <li className="inline-flex items-center gap-4">
                            <FiTruck className='text-green-900 text-xl' /> Free Shipping From €500.00
                        </li>
                        <li className="inline-flex items-center gap-4">
                            <MdPhoneInTalk className='text-green-900 text-xl' /> Support 24/7 At Anytime
                        </li>
                        <li className="inline-flex items-center gap-4">
                            <FiCreditCard className='text-green-900 text-xl' /> Secure Payment Totally Safe
                        </li>
                        <li className="inline-flex items-center gap-4">
                            <GoGift className='text-green-900 text-xl' /> Latest Offer Upto 20% Off
                        </li>
                    </ul>
                </div>
                <div className="py-10">
                    <div className="font-poppins text-[#151515] grid grid-cols-2 md:grid-cols-4 gap-4 max-w-screen-2xl mx-auto px-4 lg:px-6">
                        ...
                        <div className=''>
                            <Link className="mb-3 block" href="/">
                                <Image src={logo} alt="Grocer Point Logo" width={100} height={100} loading='lazy' />
                            </Link>
                ...
                <div className='bg-gray-100 py-12'>
                    <div className='flex justify-between items-center max-w-screen-2xl mx-auto px-4 lg:px-6'>
                        ...
                        <div className='hidden lg:block text-center font-poppins'>
                            ...
                            <h1 className='font-semibold text-2xl text-green-900'>+880123456789</h1>
                        </div>
                        <div className='hidden lg:block w-76'>
                            <Image src={payMethod} alt="Payment Method Logo" loading='lazy' />
                        </div>
                    </div>
                </div>
                <div className='mb-16 lg:mb-0 text-center py-6 font-poppins'>
                    <p className='text-black text-xs md:text-sm font-semibold'>
                        Copyright 2024 <span className='text-green-900 hover:underline cursor-pointer'>@Nur-Dev</span>, All rights reserved.
                    </p>
                </div>
            </section>
        </div>
