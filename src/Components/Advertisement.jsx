        ...
        <div className='container-width px-3 lg:px-6'>
            <div className="max-w-screen-2xl mx-auto px-4 xl:px-6 py-10 xl:py-24">
                <div className="flex justify-center lg:justify-between items-center gap-10">
                    <Image className='hidden lg:block' src={logo1} alt="Advertisement Logo" width={400} height={200} loading="lazy" />
                    <div className='w-full md:w-4/6 font-poppins text-[#151515] text-center space-y-6'>
                        ...
                        <div className='flex justify-center items-center gap-5'>
                            <Link href={"https://play.google.com/store"} target="_blank"><Image src={appStore} alt="Advertisement Logo" width={150} height={100} loading="lazy" /></Link>
                            <Link href={"https://www.apple.com/app-store"} target="_blank"><Image src={playStore} alt="Advertisement Logo" width={150} height={100} loading="lazy" /></Link>
                        </div>
                    </div>
                    <Image className='hidden lg:block' src={logo5} alt="Advertisement Logo" width={400} height={200} loading="lazy" />
                </div>
            </div>
        </div>
    );
